...
import { Link } from "react-router-dom"; // Đảm bảo cài đặt react-router-dom nếu chưa có
import "./WhatsNew.css";
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(/IMG/banner01.jpg)` }}
      >
        <p>What's New</p>
        <span>
          Just in - your daily dose of beauty freshness! Shop our new
          collections and discover your next hero product for face, body, and
          more.
        </span>
      </div>
      {/* Khu vực giới thiệu */}
      <div className="container2">
        <p>Just arrived</p>
        <span>BE THE FIRST TO SHOP NEW PLANT-POWERED FORMULAS</span>
      ...
      <div className="containerjust2">
  <img
    src="/IMG/banner.jpg"
    alt="Just Arrived"
    className="container-image2"
  />
  <h1 className="container-title23">New Double Serum</h1>
  <p className="container-description2">5 years of research on epigenetics</p>
</div>
        ...
        <form className="signup-form">
          ...
          <div className="form-row">
            <label className="checkbox-container">
              <input type="checkbox" />
              Please confirm you would like to receive Clarins French
